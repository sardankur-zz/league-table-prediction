...
print('true top 10 ', score_true[:10])
#------------------------------------SVM--------------------------------------
...
svr = svm.SVC(kernel='linear', C=100).fit(X_train_data, X_train_target)
...
print('SVM: top 10 ', score_pred_svm_top_10)
...
print('RF: top 10 ', score_pred_rf_top_10)
...
grid_search.fit(X_train_data, X_train_target)
print('log reg best config ',grid_search.best_params_)
...
print('LR: top 10 ', score_pred_lr_top_10)
...
grid_search.fit(X_train_data, X_train_target)
print('lin svc best config ',grid_search.best_params_)
...
print('LinSVC: top 10 ', score_pred_lin_top_10)
